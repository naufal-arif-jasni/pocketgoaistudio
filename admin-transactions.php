...
<div class="page page-active" id="page-admin-transactions">
  <div class="topbar-admin">
    <div style="display:flex;align-items:center;">
      ...
      <span class="admin-badge">💰 Transactions</span>
    </div>
  ...
  <div class="scroll-area-admin">
    <div style="max-width:1200px;margin:0 auto;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
        ...
        <button class="btn btn-admin" onclick="showAdminModal('transaction','create')">➕ Add Transaction</button>
      </div>
  ...
  <div class="bottom-nav-admin">
    ...
    <div class="nav-item active" data-page="admin-transactions" onclick="location.href='admin-transactions.php'"><div class="ni-icon">💰</div><div class="ni-label">Transactions</div></div>
