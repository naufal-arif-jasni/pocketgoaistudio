...
<div class="page page-active" id="page-admin-users">
  ...
  <div class="scroll-area-admin">
    <div style="max-width:1200px;margin:0 auto;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
        ...
        <button class="btn btn-admin" onclick="showAdminModal('user','create')">➕ Add User</button>
      </div>
  ...
  <div class="bottom-nav-admin">
    ...
    <div class="nav-item active" data-page="admin-users" onclick="location.href='admin-users.php'"><div class="ni-icon">👥</div><div class="ni-label">Users</div></div>
